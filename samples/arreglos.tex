...
de algunos sitios, principalmente el sitio \testsf{San Pedro} de \textsf{Elite Flowers}
...
de \testsf{San Pedro}, fallan igualmente.

\section{Diagnóstico}
Las consultas por últimas actividades de algunos de los sitios,
y en particular de \testsf{San Pedro}, ejecutan lentamente en el servidor
