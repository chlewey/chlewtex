\documentclass[spanish,utf8,onepage]{oaprop}
\usepackage{chlewid}
...
los datos al servidor de la Oruga Amarilla.
...
\chapter{Interfaz web: marco general}
\section{Servidores}
...
\chapter{Interfaz web: monitoreo, automatización y control}
\chapter{Interfaz web: compra, venta y alquiler de maquinaria y repuestos}
\chapter{Interfaz web: gestión de incidencias y tiquetes}
\chapter{Aplicación móvil de reporte de incidencias}
\chapter{Aplicación móvil de monitoreo, automatización y control}
\chapter{Hardware: módulo de control y comunicaciones para estaciones inmuebles}
\chapter{Hardware: módulo de control y comunicaciones para estaciones móviles}
\chapter{Hardware: módulo externo de comunicaciones}
\chapter{Hardware: interfaz local tipo tablero}
\chapter{Hardware: interfaz local tipo pantalla táctil}
\chapter{Hardware: interfaz local tipo pantalla, mouse y teclado}
